...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                  
      ...
      IF (stage == 1) THEN
        ...
        ALLOCATE(mesh%xy(2,mesh%nn),         STAT = alloc_status(2))
        ALLOCATE(mesh%depth(mesh%nn),        STAT = alloc_status(3))
        ALLOCATE(mesh%el_type(mesh%ne),      STAT = alloc_status(4))
        ALLOCATE(mesh%elxy(mnnds,mesh%ne,2), STAT = alloc_status(5))
        ALLOCATE(mesh%elhb(mnnds,mesh%ne),   STAT = alloc_status(6))

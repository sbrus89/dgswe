...
objects = globals.o basis.o evaluate.o read_input.o read_grid.o read_stations.o kdtree2.o stations.o

main: $(objects)
	$(CC) $(CFLAGS2) stations $(objects) $(LIB)
...
stations.o: stations.f90 globals.f90 evaluate.f90 basis.f90 kdtree2.F
	$(CC) $(CFLAGS1) $<

...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!      
      ...
      IF (stage == 1) THEN
        ...
        ALLOCATE(mesh%elhbxy(mesh%mnnds,mesh%ne,2),STAT = alloc_status(9))        
        ALLOCATE(mesh%hbxy(3,mesh%mnnds*mesh%ne),STAT = alloc_status(10))        
        ALLOCATE(mesh%vxyn(mesh%nn),STAT = alloc_status(11))
        ALLOCATE(mesh%vxy(2,mesh%nn),STAT = alloc_status(12))

      ...
      ALLOCATE(el2ged(3,ne),STAT = alloc_status)
      IF(alloc_status /= 0) THEN
        PRINT*, 'Allocation error: el2ged'
      ENDIF 
 ...
 local_ed1: DO led1 = 1,3 ! loop through trial edges
              ...
              el2ged(led1,el1) = ned ! led1 of el1 corresponds to global edge ned
     ...
     local_ed2: DO led2 = 1,3 ! loop through local test edge numbers
                  ...
                  IF(((n1ed1 == n1ed2) .AND. (n2ed1 == n2ed2)) .OR. & ! check if nodes on trial edge matches test edge
                     ...
                     el2ged(led2,el2) = ned ! led2 of el2 corresponds to global edge ned

...
# This will run all spline cases for a convergence study.  
#   - Right now the format of the spline.inp file must follow
...
for n in range(0,ncases):
  ...
  for i in range(0,nlines):                   # uncomment current case
